...
func Test_ParseETable(t *testing.T) {
	...
	str = `
		<! Entity=铁心桥 type=测试2011-11-03 dataTime='20120423 13:30:07' !>
			...
			<Line_B>
				@Num ID Name AliasName Description PathName RdfID AppFlag Substation_ID Stage_ID
				//序号 ID 名称 别名 描述 路径名 全局唯一标识 应用标志 所属电站 所属分期ID
				# 1 199284283511144474 中原1线313 $ $ 220kV守旗光伏电站.#1分期.中原1线313 $ 0 3659174697238530 169166461003104263
				# 2 199284283511144475 中原2线314 $ $ 220kV守旗光伏电站.#1分期.中原2线314 $ 0 3659174697238530 169166461003104263
				# 3 199284283511144476 中原3线315 $ $ 220kV守旗光伏电站.#1分期.中原3线315 $ 0 3659174697238530 169166461003104263
				# 4 199284283511144477 中原5线322 $ $ 220kV守旗光伏电站.#1分期.中原5线322 $ 0 3659174697238530 169166461003104263
				# 5 199284283511144478 中原6线323 $ $ 220kV守旗光伏电站.#1分期.中原6线323 $ 0 3659174697238530 169166461003104263
				# 6 199284283511144479 岜盆1线325 $ $ 220kV守旗光伏电站.#2分期.岜盆1线325 $ 0 3659174697238530 169166461003104264
				# 7 199284283511144480 岜盆2线316 $ $ 220kV守旗光伏电站.#2分期.岜盆2线316 $ 0 3659174697238530 169166461003104264
				# 8 199284283511144481 岜盆3线326 $ $ 220kV守旗光伏电站.#2分期.岜盆3线326 $ 0 3659174697238530 169166461003104264
				# 9 199284283511144558 #2储能进线 $ $ 220kV守旗光伏电站.储能.#2储能进线 $ 0 3659174697238530 169166461003104284
				# 10 199284283511144559 #1储能进线 $ $ 220kV守旗光伏电站.储能.#1储能进线 $ 0 3659174697238530 169166461003104284
				# 11 199284283511144560 #3储能进线 $ $ 220kV守旗光伏电站.储能.#3储能进线 $ 0 3659174697238530 169166461003104284
				# 12 199284283511144561 中原7线324 $ $ 220kV守旗光伏电站.#1分期.中原7线324 $ 0 3659174697238530 169166461003104263
			</Line_B>
	`
	fmt.Println("多列式:")
	root, err = efile.ParseRootString(str)
	...
	for iter := root.Children.Front(); iter != nil; iter = iter.Next() {
		node := iter.Value
		records, err := efile.ParseETable(root, node.Name)
		if err != nil {
			fmt.Println(err)
			t.Errorf("%s", err.Error())
			return
...
func Test_ParseETables(t *testing.T) {
	str := `
		<! Entity=铁心桥 type=测试2011-11-03 dataTime='20120423 13:30:07' !>
			<DG::铁心桥 date='2012-04-23' DDMM='达梦' >
				@#顺序 属性名 '花花电网' '花花电网' '花花电网' '花花电网' 
	...
	if tables, err := efile.ParseETables(root); err != nil {
		t.Errorf("%s", err.Error())
		return
	} else {
