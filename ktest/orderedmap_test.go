...
func TestUnmarshalJSONStruct(t *testing.T) {
	var v struct {
		Data *kmaps.OrderedMap `json:"data"`
	}
...
`
	o := kmaps.NewOrderedMap()
	json.Unmarshal([]byte(s), &o)
	o.Sort(func(a *kmaps.Pair, b *kmaps.Pair) bool {
